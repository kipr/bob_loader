...
#define PIN_PWM4_OFF {1<<22, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define PIN_PWM5_OFF {1<<23, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define PIN_PWM6_OFF {1<<24, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define PIN_PWM7_OFF {1<<25, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
...
#define PIN_PB6  {1<<6,  AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_PULLUP}
#define PIN_PB7  {1<<7,  AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_PULLUP}
#define PIN_PB8  {1<<8,  AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_PULLUP}
#define PIN_PB9  {1<<9,  AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_PULLUP}
#define PIN_PB10 {1<<10, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_PULLUP}
#define PIN_PB11 {1<<11, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_PULLUP}
#define PIN_PB12 {1<<12, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_PULLUP}
#define PIN_PB13 {1<<13, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_PULLUP}
...
// Pullup Select Pins
#define PIN_PA12 {1<<12, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_PA13 {1<<13, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_PA14 {1<<14, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_PA5	 {1<<5, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_PA6  {1<<6, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}

// Black Button
#define PIN_PB0 {1<<0, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_DEFAULT}

// Sensor Voltage rails
#define PIN_PB4 {1<<4, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_DEFAULT}
#define PIN_PB5 {1<<5, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_DEFAULT}

// Chumby SPI
#define PIN_SPI0_SPCK  {1<<11, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT}
#define PIN_SPI0_MOSI  {1<<15, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT}
#define PIN_SPI0_MISO  {1<<16, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT}
#define PIN_SPI0_NPSC0 {1<<17, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT}

#define PINS_SPI0 PIN_SPI0_SPCK,PIN_SPI0_MOSI,PIN_SPI0_MISO,PIN_SPI0_NPSC0
...
// Chumby Bend
#define PIN_PB2 {1<<2, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_OUTPUT_0, PIO_DEFAULT}

// Chumby Reset
#define PIN_PB3 {1<<3, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT, PIO_DEFAULT}
...
// Analog Sensor Pins
#define ANG0 PIN_ADC0_AD4
#define ANG1 PIN_ADC0_AD5
#define ANG2 PIN_ADC0_AD6
#define ANG3 PIN_ADC0_AD7
#define ANG4 PIN_ADC1_AD0
#define ANG5 PIN_ADC1_AD1
#define ANG6 PIN_ADC1_AD2
#define ANG7 PIN_ADC1_AD3

#define ANALOG_SENSORS ANG0,ANG1,ANG2,ANG3,ANG4,ANG5,ANG6,ANG7
                  
#define PULLUP_EN	PIN_PA5
#define PULLUP_DATA	PIN_PA6
#define PULLUP_ADDA	PIN_PA14
#define PULLUP_ADDB	PIN_PA13
#define PULLUP_ADDC	PIN_PA12

// Power on the sensor voltage rails
#define SEN_VEN   PIN_PB4
#define SEN_VSTAT PIN_PB5

#define SENSOR_POWER SEN_VEN,SEN_VSTAT
...
#define MC_DIR MC_DIR0,MC_DIR1,MC_DIR2,MC_DIR3

#define MADC0 PIN_ADC0_AD1
#define MADC1 PIN_ADC0_AD0
#define MADC2 PIN_ADC0_AD2
#define MADC3 PIN_ADC0_AD3
#define MADC4 PIN_ADC1_AD4
#define MADC5 PIN_ADC1_AD5
#define MADC6 PIN_ADC1_AD6
#define MADC7 PIN_ADC1_AD7
...
// Chumby Pins
#define CHUMBY_RESET PIN_PB3
#define CHUMBY_BEND  PIN_PB2

#define CHUMBY_SPCK  PIN_SPI0_SPCK
#define CHUMBY_MOSI  PIN_SPI0_MOSI
#define CHUMBY_MISO  PIN_SPI0_MISO
#define CHUMBY_NPSC0 PIN_SPI0_NPSC0

#define CHUMBY CHUMBY_RESET,CHUMBY_BEND,CHUMBY_SPCK,\
               CHUMBY_MOSI,CHUMBY_MISO,CHUMBY_NPSC0
